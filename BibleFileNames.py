'''
DO NOT DELETE!
While this file appears useless, it is very useful and is
referenced many times.
Its usefulness stems from being handily there so that
one does not have to repeatedly type out all the books
of the Bible(and risk spelling mistakes!).
'''
import list_and_str_ops as ops
...
def setsearchrange(book,chapter):
    indexofbook = files.index(f'{ops.disclean(book)}')
    files = [indexofbook]